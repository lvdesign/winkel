...
jQuery(function(){
/*var featurePics = new Array( "../doc_lif/life_slides/lif0.jpg",);*/

 //methode jquery
 $(document).ready(function(){
 $.get('../lifestyle/doc_lif/bmwLifeCm.xml', function(data){
...
var lien  ="../lifestyle/doc_lif/life_slides/lif"+ i + ".jpg";
...
//nb selon le fichier le nb de vignette ds le theme xml charge
	...
	*/
	jQuery('#carousel-photos-bmw').cycle({ 
		...
		prev:		null, // ID of what to use for prev button
		next:		null, // ID of what to use for next button
